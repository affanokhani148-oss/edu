...
export default function EditArticle({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.ok) {
      ...
      setMessage('❌ Error: ' + (err.error || 'Failed to update article'));
    }
    setSaving(false);
  };
    ...
    <div>
      <div className="section-header">
        <div>
          ...
          <p className="section-subtitle">Update article details, visibility, and community</p>
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div className="card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div className="form-group">
                  ...
                  <input name="slug" className="form-input" value={form.slug} onChange={handleChange} required style={{ fontFamily: 'monospace' }} />
                </div>

                <div className="form-group">
                  <label className="form-label">SEO Description *</label>
                  <textarea name="description" className="form-textarea" value={form.description || ''} onChange={handleChange} required rows={3} style={{ minHeight: '80px' }} />
                </div>
            ...
            <div className="card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div className="form-group">
                  <label className="form-label">Replace HTML File</label>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <button type="submit" disabled={saving} className="btn btn-primary btn-block" style={{ padding: '1rem', fontSize: '1rem' }}>
