...
const navItems = [
  ...
  { href: '/student/quizzes', label: 'Daily Quizzes', icon: '❓', exact: true },
  { href: '/student/history', label: 'Quiz History', icon: '📊' },
  { href: '/student/chat', label: 'Chat with Admin', icon: '💬' },
  { href: '/student/reviews', label: 'Write a Review', icon: '⭐' },
];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: 'var(--color-background)' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <Link href="/student" style={{ fontSize: '1.4rem', fontWeight: 800, color: 'var(--color-text-primary)', textDecoration: 'none' }}>
            Edu<span style={{ color: 'var(--color-primary)' }}>Pro</span> <span style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--color-text-secondary)', marginLeft: '0.5rem', textTransform: 'uppercase' }}>Student</span>
          </Link>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <DarkModeToggle />
      ...
      <div style={{ display: 'flex', flexGrow: 1, position: 'relative' }}>
        ...
        <aside style={{
          ...
          <nav style={{ padding: '1.5rem 1rem', flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
            <p style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--color-text-secondary)', textTransform: 'uppercase', letterSpacing: '1px', margin: '0 0 0.5rem 0.5rem' }}>Navigation</p>
            {navItems.map(item => (
